DCM_to_NRRD.py, convert T2WI dicome images to nrrd format source: https://github.com/jiahui604/Automated-Prostate-Cancer-Detection-using-MRI/blob/master/Preprocessing/convert_to_nrrd.py
